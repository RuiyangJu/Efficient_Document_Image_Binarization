...
# stage3
weight_folder = './Unet/stage3_dibco_' + base_model_name + '_' + str(int(lambda_loss)) + '_' + str(generator_lr) + '/'
...
weight_folder = './Unet/stage3_resize_dibco_' + base_model_name + '_' + str(int(lambda_loss)) + '_' + str(generator_lr) + '/'
weight_list = os.listdir(weight_folder)
