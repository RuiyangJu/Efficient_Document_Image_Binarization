...
def unet_train(epochs, gpu, base_model_name, encoder_weights, generator_lr, discriminator_lr, lambda_loss,
    ...
    # make directory
    weight_path = './Unet/stage3_dibco_' + base_model_name + '_' + str(int(lambda_loss)) + '_' + str(generator_lr)
...
if __name__ == "__main__":
    ...
    # data set
    parser.add_argument('--image_train_dir', type=str, default='./Unet/predicted_image_for_stage3_dibco_Unet/train/patch/image/', help='patched stage2 prdiction image train dir')
    parser.add_argument('--mask_train_dir', type=str, default='./Unet/predicted_image_for_stage3_dibco_Unet/train/patch/mask/', help='patched stage2 prdiction mask train dir')
    parser.add_argument('--image_test_dir', type=str, default='./Unet/predicted_image_for_stage3_dibco_Unet/test/', help='stage2 prdiction image test dir')
