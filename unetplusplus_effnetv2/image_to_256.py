...
def main(argv=None):
    ...
    image_save_dir = './Ours_resize_256/Trainset/image/'
    mask_save_dir = './Ours_resize_256/Trainset/mask/'
    ...
    for image_path in image_pathes:
        ...
        elif os.path.isfile(os.path.join(mask_dir, image_name) + '.jpg'):
            mask = cv2.imread(os.path.join(mask_dir, image_name) + '.jpg', cv2.IMREAD_GRAYSCALE)
        else:
